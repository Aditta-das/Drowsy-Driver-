...
class DrowsiDriver:
    def __init__(self):
        ...
        self.faceCascade = "G:/Bideshi/Drowsy-Driver-/haarcascade_frontalface_default.xml"
        self.eyeCascade = "G:/Bideshi/Drowsy-Driver-/haarcascade_lefteye_2splits.xml"
        self.loadModel = "G:/Bideshi/Drowsy-Driver-/drowsyfile1.h5" 
        self.alarmSound = "G:\\Bideshi\\Drowsy-Driver-\\alert_signal.mp3"
        self.IMG_SIZE = 145
        self.counting = 0
        self.alarm_on = False
